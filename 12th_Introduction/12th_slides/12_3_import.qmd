---
title: "Day 1, Part 3: Import Your Data"
...
-   The answer depends on how you run your code and how you opened the session:
    ...
    -   If you run the code in a script by using [`source()`]{.underline}, then **it is that script's folder**
...
1.  Follow the instructions in 12_1\_begin.Rmd!
...
4.  Copy and paste the code for importing your data from 12_1\_begin.Rmd and try running it.
